...
import static com.webfunny.rum.WebfunnyRum.APP_NAME_KEY;
import static com.webfunny.rum.WebfunnyRum.COMPONENT_APPSTART;
import static com.webfunny.rum.WebfunnyRum.COMPONENT_ERROR;
import static com.webfunny.rum.WebfunnyRum.COMPONENT_KEY;
import static com.webfunny.rum.WebfunnyRum.COMPONENT_UI;
import static com.webfunny.rum.WebfunnyRum.RUM_TRACER_NAME;
...
import com.webfunny.rum.internal.UInt32QuadXorTraceIdRatioSampler;
...
class RumInitializer {
    ...
    private final WebfunnyRumBuilder builder;
    private final Application application;
    private final AppStartupTimer startupTimer;
    private final InitializationEvents initializationEvents;

    RumInitializer(
            WebfunnyRumBuilder builder, Application application, AppStartupTimer startupTimer) {
    ...
    WebfunnyRum initialize(Looper mainLooper) {
        ...
        otelRumBuilder.mergeResource(createWebfunnyResource());
        ...
        return new WebfunnyRum(openTelemetryRum, globalAttributeSupplier);
    }
                ...
                instrumentedApp -> {
                    ...
                    AndroidLifecycleInstrumentation instrumentation =
                            AndroidLifecycleInstrumentation.builder()
                                    ...
                                    .setScreenNameExtractor(WebfunnyScreenNameExtractor.INSTANCE)
                                    .build();
    ...
    /**
     * Creates a minimal Webfunny-specific resource. This will be blended with the upstream
     * AndroidResource.
     */
    private Resource createWebfunnyResource() {
    ...
    SpanExporter buildFilteringExporter(
        ...
        SpanExporter webfunnyTranslatedExporter =
                new WebfunnySpanDataModifier(exporter, builder.isReactNativeSupportEnabled());
        SpanExporter filteredExporter = builder.decorateWithSpanFilter(webfunnyTranslatedExporter);
