...
/**
 * Screen name extractor that supports the original Webfunny annotation but falls back to
 * OpenTelemetry defaults when not present.
 */
class WebfunnyScreenNameExtractor implements ScreenNameExtractor {

    static ScreenNameExtractor INSTANCE = new WebfunnyScreenNameExtractor();

    private WebfunnyScreenNameExtractor() {}
