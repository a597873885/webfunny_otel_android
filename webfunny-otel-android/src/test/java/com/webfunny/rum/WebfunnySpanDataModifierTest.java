...
import static com.webfunny.rum.WebfunnySpanDataModifier.REACT_NATIVE_SPAN_ID_KEY;
import static com.webfunny.rum.WebfunnySpanDataModifier.REACT_NATIVE_TRACE_ID_KEY;
import static com.webfunny.rum.WebfunnySpanDataModifier.Webfunny_OPERATION_KEY;
...
class WebfunnySpanDataModifierTest {
    ...
    void changesSpanIdAttrName() {
        ...
        WebfunnySpanDataModifier underTest = new WebfunnySpanDataModifier(delegate, false);
    ...
    void shouldConvertExceptionEventsToSpanAttributes() {
        ...
        SpanExporter underTest = new WebfunnySpanDataModifier(delegate, false);
    ...
    void shouldSetCaseSensitiveSpanNameToAttribute() {
        SpanData original = startBuilder("WebfunnyRumSpan").build();
        ...
        assertThat(exportedSpans).hasSize(1);
        assertThat(exportedSpans.iterator().next())
                .hasName("WebfunnyRumSpan")
                .hasAttributesSatisfyingExactly(equalTo(Webfunny_OPERATION_KEY, "WebfunnyRumSpan"));
    }
    ...
    void shouldCopySelectedResourceAttributes() {
        Resource resource =
                Resource.create(
                        Attributes.builder()
                                ...
                                .put(WebfunnyRum.APP_NAME_KEY, "myApp")
                                .put(WebfunnyRum.RUM_VERSION_KEY, "1.0.0")
                                .build());

        SpanData original =
                TestSpanData.builder()
                        .setName("WebfunnyRumSpan")
        ...
        assertThat(exportedSpans.iterator().next())
                .hasName("WebfunnyRumSpan")
                .hasAttributesSatisfyingExactly(
                        equalTo(Webfunny_OPERATION_KEY, "WebfunnyRumSpan"),
                        ...
                        equalTo(WebfunnyRum.APP_NAME_KEY, "myApp"),
                        equalTo(WebfunnyRum.RUM_VERSION_KEY, "1.0.0"));
    }
    ...
    void shouldReplaceTraceAndSpanIdWithReactNativeIds() {
        ...
        SpanExporter underTest = new WebfunnySpanDataModifier(delegate, true);
        CompletableResultCode actual = underTest.export(singleton(original));
