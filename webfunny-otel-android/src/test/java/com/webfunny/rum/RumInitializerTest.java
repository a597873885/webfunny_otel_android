...
class RumInitializerTest {
    ...
    void initializationSpan() {
        ...
        RumInitializer testInitializer =
                new RumInitializer(webfunnyRumBuilder, application, startupTimer) {
                    @Override
        ...
        WebfunnyRum webfunnyRum = testInitializer.initialize(mainLooper);
        startupTimer.runCompletionCallback();
        webfunnyRum.flushSpans();
        ...
        assertEquals("Webfunny.initialize", initSpan.getName());
    ...
    void canCustomizeHttpSender() {
        ...
        RumInitializer testInitializer =
                new RumInitializer(webfunnyRumBuilder, application, new AppStartupTimer());
        WebfunnyRum rum = testInitializer.initialize(mainLooper);
    ...
    void shouldTranslateExceptionEventsToSpanAttributes() {
        ...
        RumInitializer initializer =
                new RumInitializer(webfunnyRumBuilder, application, appStartupTimer) {
                    @Override
                    SpanExporter getCoreSpanExporter() {
                        return spanExporter;
                    }
        ...
        WebfunnyRum webfunnyRum = initializer.initialize(mainLooper);
        appStartupTimer.runCompletionCallback();

        Exception e = new IllegalArgumentException("booom!");
        webfunnyRum.addRumException(e, Attributes.of(stringKey("attribute"), "oh no!"));
        webfunnyRum.flushSpans();
