    ...
    void nameReplacement() {
        ...
        Span span =
                Span.newBuilder()
                        ...
                        .putTag(WebfunnySpanDataModifier.Webfunny_OPERATION_KEY.getKey(), "UpperCase")
                        .build();
        byte[] bytes = encoder.encode(span);
        // this assertion verifies that we changed the name
        assertEquals(
                "{\"traceId\":\"00000000000000010000000000000002\",\"id\":\"0000000000000001\",\"name\":\"UpperCase\",\"tags\":{\"_webfunny_operation\":\"UpperCase\"}}",
                new String(bytes));
