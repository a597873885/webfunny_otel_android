...
public class DemoWorker extends Worker {
    ...
    public static final String TAG = "WebfunnyRum";
    ...
    public Result doWork() {
        try {
            WebfunnyRum.getInstance().addRumEvent("DemoWorker is doing work", Attributes.empty());
    ...
    private void startBackgroundService() {
        Intent serviceIntent = new Intent(context, WebfunnyBackgroundService.class);
