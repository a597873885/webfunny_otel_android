...
import com.webfunny.android.sample.databinding.FragmentWebViewBinding;
...
public class WebViewFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        WebfunnyRum.getInstance().integrateWithBrowserRum(binding.webView);
    }
    ...
    public static class WebAppInterface {
        ...
        public void showToast(String toast) {
            WebfunnyRum.getInstance().addRumEvent("WebViewButtonClicked", Attributes.empty());
