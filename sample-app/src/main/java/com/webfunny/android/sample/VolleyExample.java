...
import com.webfunny.rum.VolleyTracing;
 ...
 * Webfunny Android Volley instrumentation.
 */
public class VolleyExample {

    private static final String URL =
            "https://frontend-us.splunko11y.com?user=me&pass=secret123secret";
    private final WebfunnyRum webfunnyRum;

    public VolleyExample(WebfunnyRum webfunnyRum) {
        this.webfunnyRum = webfunnyRum;
    }
    ...
    public void doHttpRequest() {
        ...
        VolleyTracing volleyTracing =
                VolleyTracing.builder(webfunnyRum)
        ...
        Request<?> request =
                new StringRequest(
                    ...
                    public Map<String, String> getHeaders() {
                        ...
                        extraHeaders.put(
                                "X-Android-Instrumentation-Example", "webfunny-otel-android");
                        return extraHeaders;
                    }
                };
        queue.add(request);
