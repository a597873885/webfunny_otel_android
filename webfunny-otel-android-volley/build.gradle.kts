...
android {
    namespace = "com.webfunny.android.rum.volley"
...
dependencies {
    ...
    implementation(project(":webfunny-otel-android"))
...
extra["pomName"] = "Webfunny Otel Android Volley"
description = "A library for instrumenting Android applications using Volley Library for Webfunny RUM"
