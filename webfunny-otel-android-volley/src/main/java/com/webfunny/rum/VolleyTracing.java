...
public final class VolleyTracing {
    ...
    /** Returns a new {@link VolleyTracing} configured with the given {@link WebfunnyRum}. */
    public static VolleyTracing create(WebfunnyRum webfunnyRum) {
        return create(webfunnyRum.getOpenTelemetry());
    }
    ...
    /** Returns a new {@link VolleyTracingBuilder} configured with the given {@link WebfunnyRum}. */
    public static VolleyTracingBuilder builder(WebfunnyRum webfunnyRum) {
        return new VolleyTracingBuilder(webfunnyRum.getOpenTelemetry());
    }
